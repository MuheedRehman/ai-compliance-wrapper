...
- Latest deployed staging baseline: commit `41976e7` via Cloud Build `c113c92c-bde4-40a7-ad4d-29d29eca5e09` with status `SUCCESS`.
- Live staging URLs:
...
- Latest verified Cloud Run revisions:
  - Dashboard: `ai-compliance-dashboard-00041-xz2`
  - Backend: `ai-compliance-backend-00079-xm6`
