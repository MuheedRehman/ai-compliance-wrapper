...
1. Module 3 workspace drill-down actions are deployed; next workspace polish can deepen section-specific create/edit flows, or the product can move to Module 5 evidence uploads.
...
- Module 3 Workspace Drill-Down Actions: deployed to staging. AI System workspaces now expose actionable entry points for controls, evidence, reports, FRIA, oversight, incidents, and follow-up tasks.
