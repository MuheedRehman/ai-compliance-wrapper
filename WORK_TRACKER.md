...
- Latest deployed staging baseline: commit `fa42d6b` via Cloud Build `60776990-d787-4535-8db6-60e49b9f7ec6` with status `SUCCESS`.
- Live staging URLs:
...
- Latest verified Cloud Run revisions:
  - Dashboard: `ai-compliance-dashboard-00048-928`
  - Backend: `ai-compliance-backend-00093-ljz`
